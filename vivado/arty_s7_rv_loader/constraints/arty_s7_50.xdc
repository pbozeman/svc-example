...
## Pmod Header JD
## Pmod USBUART on JD: Pin 2 (jd[1]) = TXD (FPGA→USB)
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports PMOD_UART_TX]
...
set_switching_activity -toggle_rate 0 -static_probability 1.0 [get_nets -hier *rst_n*]
